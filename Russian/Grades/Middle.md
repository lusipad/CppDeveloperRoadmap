...
- Также ориентируется в инструментах, которые помогают поддерживать цикл разработки кода в проекте:
    ...
    - Автоматизация качества кода (форматирование, статический анализ, санитайзеры, проверки в CI)
    - Доставка
    - Выполнение на целевой системе
- Понимает практический статус современных стандартов C++ и умеет выбирать возможности с учетом компилятора, платформы и ограничений команды, а не только по новизне.
