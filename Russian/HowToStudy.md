...
## :question: Как учить современные стандарты C++?

Новичкам можно посоветовать сильно не акцентироваться на стандартах в начале своего обучения. Начните с книг из списка [для начинающих](Books/PreJunior.md), и начинайте изучать фундаментальные основы. Современные книги для новичков обычно сначала знакомят с базой C++11/14, потому что она до сих пор лежит в основе большей части современного C++ кода. В начале лучше понять модель языка, чем гнаться за каждой новой возможностью.
...
C++ развивается похожим образом, как и другие языки: берётся какая-то популярная идея из информатики (computer science) или удачная фича из других языков, и внедряется в язык. Изучать такие конструкции и использовать их важно, но сначала стоит изучить основы, которые были заложены стандартами C++11/14/17. После этого C++20 стоит воспринимать как современную базовую линию: concepts, ranges, coroutines, modules и другие возможности всё чаще встречаются в реальных проектах. За C++23 и C++26 тоже полезно следить после закрепления основ: они добавляют важные улучшения библиотеки и показывают направление развития экосистемы, но компиляторы и проекты принимают их с разной скоростью.

## :question: По каким источникам изучать новые возможности стандартов C++?

- Доклады на [конференциях по C++](CommunitySources.md)
- На главной странице [CppReference](https://en.cppreference.com/w/cpp) вы найдете ссылки, со списками возможностей, введенных в последних стандартах С++
...
- Страницы поддержки возможностей у [GCC](https://gcc.gnu.org/projects/cxx-status.html), [Clang](https://clang.llvm.org/cxx_status.html) и [MSVC](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-language-conformance) помогают понять, какие возможности C++20/23/26 реально доступны в проектах
...
- Учитесь в своем ритме, а также в любом возрасте! Не акцентрируйтесь на историях: "Я программирую с пеленок" и т.п.. Большинство подобных историй — [систематическая ошибка выжившего](https://ru.wikipedia.org/wiki/%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B0%D1%8F_%D0%BE%D1%88%D0%B8%D0%B1%D0%BA%D0%B0_%D0%B2%D1%8B%D0%B6%D0%B8%D0%B2%D1%88%D0%B5%D0%B3%D0%BE), или же попытка потешить свое самолюбие за ваш счет. У вас достаточно способностей, чтобы научиться программированию, в том числе с нуля, в том числе и на C++!
