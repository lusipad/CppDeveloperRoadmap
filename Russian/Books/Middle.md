...
- [Скотт Мейерс - Эффективный и современный С++. 42 рекомендации по использованию C++11 и C++14](https://www.ozon.ru/product/effektivnyy-i-sovremennyy-s-42-rekomendatsii-po-ispolzovaniyu-c11-i-c14-effektivnyy-i-sovremennyy-34747131/?sh=CHL5ECEP)
    ...
    Сборник практических советов для работы со стандартами C++11 и C++14. Это уже не руководство по текущему стандарту C++, но книга всё ещё отлично помогает понять основу современного стиля C++.
...
- [Дэвид Вандевурд - Шаблоны C++. Справочник разработчика](https://www.ozon.ru/product/shablony-c-spravochnik-razrabotchika-145861864)
    ...
    Фундаментальная работа по шаблонам и метапрограммированию в C++, включая техники, добавленные вплоть до C++17. Если вам необходимо писать параметризуемый код, то этот справочник станет мощной опорой. Более новые возможности, например concepts, стоит дополнительно изучать по актуальным справочным материалам.

## :rocket: Современные стандарты и справочники

- [CppReference](https://en.cppreference.com/w/cpp)

    Используйте как ежедневный справочник по стандартной библиотеке и возможностям C++20, C++23 и C++26.

- [Compiler Explorer](https://gcc.godbolt.org)

    Практичный способ сравнить компиляторы, режимы стандарта, сгенерированный ассемблер и поддержку современных возможностей.

- [Страницы поддержки возможностей у GCC](https://gcc.gnu.org/projects/cxx-status.html), [Clang](https://clang.llvm.org/cxx_status.html) и [MSVC](https://learn.microsoft.com/en-us/cpp/overview/visual-cpp-language-conformance)

    Эти страницы помогают решать, готова ли возможность для вашего проекта, вместо ориентации только на год стандарта.

- [C++ Core Guidelines](https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines)

    Живой набор рекомендаций по более безопасному и сопровождаемому C++ коду.
