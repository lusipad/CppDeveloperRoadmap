...
以下是不包含复杂 AI 或动态世界生成内容，但适合作为起点实现的经典游戏列表。你可以在进展过程中逐步增加额外功能。对于图形库，可以使用易于上手、且足以创建简单 2D 或 2.5D 图形界面的 [SFML](https://www.sfml-dev.org/)。如果你想做带有物理效果的复杂项目，可以从简单引擎如 [Box2D](https://box2d.org/) 开始，也可以学习更高级的引擎，如 [Cocos2D](https://www.cocos.com/en/) 和 [Unreal Engine](https://www.unrealengine.com/en-US/)。记得遵循“从简单到复杂”的规则，先从简单游戏开始，然后逐渐增加难度。
...
建议阅读以下资源，其中包含有关游戏开发算法的信息。它们可能对上述游戏或你自己的创意有帮助：
